          ...
          >
            ...
            <div class="page-title d-flex flex-column gap-1 me-3 mb-2">
              ...
              >
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-gray-700">eCommerce</li>
                <!--end::Item-->
              </ul>
              <!--end::Breadcrumb-->
              <!--begin::Title-->
        ...
        >
         ...
         <div class="row g-5 g-xl-10 mb-xl-10">
                ...
                >
                  ...
                  >
                    ...
                    >
                      <!--begin::Bullet-->
                      <div
                        class="bullet w-8px h-6px rounded-2 bg-danger me-3"
                      ></div>
                      <!--end::Bullet-->
                      <!--begin::Label-->
                ...
                >
                  ...
                  <div class="px-9 mb-5">
                    ...
                    <div class="d-flex mb-2">
                      <span class="fs-4 fw-semibold text-gray-400 me-1"
                        >$</span
                      >
                      <span
          ...
          <div class="row gx-5 gx-xl-10">
            ...
            <!--end::Col-->
            <!--begin::Col-->
            <div class="col-xl-12 col-xxl-6  mb-5 mb-xl-10">
                    ...
                    >
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <span
                              class="text-gray-800 fw-bold d-block fs-6 ps-0 text-end"
                              >$72.00</span
                            >
                          </td>
                        </tr>
