            ...
            try {
                return `<div ${this.getAttributes(tagData)} class='tagify__dropdown__item  '>
                            <span >${tagData.value}</span>
                                                        <span  style="background:${tagData.code};width:40px;height:40px; padding:5px; color:white; border-radius:3px;">${tagData.value}</span>
                        </div>`
            }
            catch (err) { }
        }
...
tagify.addTags(tagsToAdd);
    ...
    whitelist: [
        { value: 'XS', },
        { value: 'S', searchBy: 'beach, sub-tropical' },
        { value: 'M	', },
        { value: 'L',},
        { value: 'XL',},
        { value: 'XXL',},
